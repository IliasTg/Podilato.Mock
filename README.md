# Podilato.Mock.Entry.Level.Analysis

Income/expense entry-level analysis, Profitability & Break-Even Point of fictitious Data for educational/tool-practise purposes
...
With a net result indicating profit, a costing process was carried out to identify the most profitable activity of the company. In the "2.COSTING" tab, a breakdown of the company's expenses was performed. Using the COUNTIF function, expenses were calculated by category and then distributed to income sources. Fixed and variable costs were calculated for each company activity and compared with the corresponding revenue they generated.

Using COUNTIF, revenues were calculated per activity of the company, as shown in the "3.NET RESULTS BY CATEGORY" tab. Costing revealed that certain company activities were causing money losses. The results are now shown per activity after expense distribution (tab 3).
